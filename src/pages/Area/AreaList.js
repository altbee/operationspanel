...
class AreaList extends Component {
  ...
  componentDidMount() {
    ...
    header.setTitle(
      T.translate("areas.list.title"),
      T.translate("areas.list.description")
    );
    header.setActions([
      <Link
        to={{
          ...
          state: {
            modal: true,
            modalTitle: T.translate("areas.form.title.create")
          }
        }}
        className="btn btn btn-secondary btn-rounded px-3"
      >
        <FontAwesomeIcon icon="plus" /> {T.translate("areas.list.add")}
      </Link>
    ]);
  }
  ...
  render() {
    ...
    return [
      <Container key="area-list-container" className="pt-3">
        <div className="box">
                    ...
                    <div className="btn-group" role="group">
                      <Link
                        to={{
                          ...
                          state: {
                            modal: true,
                            modalTitle: T.translate("areas.detail.title")
                          }
                        }}
                        className="btn btn-primary btn-sm"
                        title={T.translate("areas.list.viewTooltip")}
                      >
                      ...
                      <Link
                        ...
                        to={{
                          ...
                          state: {
                            modal: true,
                            modalTitle: T.translate("areas.form.title.update")
                          }
                        }}
                        title={T.translate("areas.list.editTooltip")}
                      >
                      ...
                      {hasRoles(ROLE.ADMIN) && (
                        <Button
                          size="sm"
                          color="primary"
                          title={T.translate("areas.list.deleteTooltip")}
                          onClick={() => {
                            this.setState({
      ...
      <SweetAlert
        ...
        title={T.translate("areas.list.deleteWarning.title", {
          itemToBeDeleted: selectedItemToBeDeleted
            ? selectedItemToBeDeleted.name
            : ""
        })}
        text={T.translate("areas.list.deleteWarning.message")}
        type="warning"
        showCancelButton
        confirmButtonText={T.translate(
          "areas.list.deleteWarning.confirmButton"
        )}
        cancelButtonText={T.translate("areas.list.deleteWarning.cancelButton")}
...
export default withHeader(AreaList);
